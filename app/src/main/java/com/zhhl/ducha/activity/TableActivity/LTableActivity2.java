 ...
 */
public class LTableActivity2 extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    @BindView(R.id.back)
    RelativeLayout back;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ltableactivity2);
    ...
    private void getDate() {
        ...
        RequestCenter.request_Qishi11(params, new DisposeDataListener() {
            @Override
            public void onSuccess(Object o) {
                progressDialog.dismiss();
                Log.e("重点人异地居住一年以上统计", o.toString());
