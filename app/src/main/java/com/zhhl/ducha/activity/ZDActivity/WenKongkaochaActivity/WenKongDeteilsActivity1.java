 ...
 */
public class WenKongDeteilsActivity1 extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void getdata() {
        ...
        RequestCenter.request_Qishi7_details(params, new DisposeDataListener() {
            @Override
            public void onSuccess(Object o) {
                ...
                wenKongdetalisAdapter1 = new WenKongdetalisAdapter1(WenKongDeteilsActivity1.this, wenkonglist);
