...
import com.zhhl.ducha.adapter.ZDKeyAdapter.jiyaadapter.JYdetaactivitydetalisAdapter;
...
/**
 * Created by qgl on 2019/9/18 8:30.
 */
public class JYdetaActivityDeteils extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener
{
    @BindView(R.id.back)
    RelativeLayout back;
    @BindView(R.id.de_t1)
    ...
    private JYdetaactivitydetalisAdapter one_case_adapter;
    private String idcrad;
    private ListView mListView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private JYDeaddeteilsbean zDyiniandetailsbean;
    private List<JYDeaddeteilsbean.AttributesBean.ZdrListBean> zdrListBeans;
    ProgressDialog progressDialog;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.jydetaactivitydeteils);
    ...
    private void getdata() {
        ...
        RequestCenter.request_Qishi4_details(params, new DisposeDataListener()
        {
            @Override
            public void onSuccess(Object o)
            {
                progressDialog.dismiss();
                Log.e("羁押已死亡详情返回数据", o.toString());
                final String aa = o.toString();
                zDyiniandetailsbean = JSON.parseObject(aa, JYDeaddeteilsbean.class);
                ...
                one_case_adapter = new JYdetaactivitydetalisAdapter(JYdetaActivityDeteils.this, zdrListBeans);
