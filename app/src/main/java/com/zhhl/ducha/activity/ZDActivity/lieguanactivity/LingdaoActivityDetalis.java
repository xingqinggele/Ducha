...
import com.zhhl.ducha.adapter.ZDKeyAdapter.lieguanadpter.KeyperdetalisAdapter;
 ...
 */
public class LingdaoActivityDetalis extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getdata() {
        ...
        RequestCenter.request_Qishi1_Detalis(params, new DisposeDataListener() {
            ...
            public void onSuccess(Object o) {
                ...
                one_case_adapter = new KeyperdetalisAdapter(LingdaoActivityDetalis.this, extraData);
