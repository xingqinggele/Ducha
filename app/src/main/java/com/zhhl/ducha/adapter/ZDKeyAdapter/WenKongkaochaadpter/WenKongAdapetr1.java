 ...
 */
public class WenKongAdapetr1 extends RecyclerView.Adapter<WenKongAdapetr1.ViewHolder>
{
    ...
    public WenKongAdapetr1(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent=new Intent(mContext, WenKongDeteilsActivity1.class);
