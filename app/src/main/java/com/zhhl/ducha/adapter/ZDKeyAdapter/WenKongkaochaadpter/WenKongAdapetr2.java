...
import com.zhhl.ducha.activity.ZDActivity.WenKongkaochaActivity.WenKongDeteilsActivity2;
 ...
 */
public class WenKongAdapetr2 extends RecyclerView.Adapter<WenKongAdapetr2.ViewHolder>
{
    private Context mContext;
    private List<WenKongbean1.AttributesBean.VarListBean> dataList = new ArrayList<>();


    public void addAllData(List<WenKongbean1.AttributesBean.VarListBean> dataList) {
    ...
    public WenKongAdapetr2(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent=new Intent(mContext, WenKongDeteilsActivity2.class);
