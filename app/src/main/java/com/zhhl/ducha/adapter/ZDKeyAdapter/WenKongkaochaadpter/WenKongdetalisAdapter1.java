package com.zhhl.ducha.adapter.ZDKeyAdapter.WenKongkaochaadpter;
 ...
 */
public class WenKongdetalisAdapter1 extends BaseAdapter
{
    List<WenKongDeteilsbean1.AttributesBean.ZdrListBean> apk_list;
    LayoutInflater inflater;
    private Context context;
    private int selectorPosition;

    public WenKongdetalisAdapter1(Context context, List<WenKongDeteilsbean1.AttributesBean.ZdrListBean> apk_list)
    {
    ...
    public void onDateChange(List<WenKongDeteilsbean1.AttributesBean.ZdrListBean> apk_list)
    {
        this.apk_list = apk_list;
    ...
    {
        // TODO Auto-generated method stub
        final WenKongDeteilsbean1.AttributesBean.ZdrListBean entity = apk_list.get(position);
        ViewHolder holder;
        if (convertView == null)
        {
...
//        点击收缩按钮
    ...
    public void addListView(WenKongDeteilsbean1.AttributesBean.ZdrListBean pBean)
    {
        apk_list.add(pBean);
