package com.zhhl.ducha.adapter.ZDKeyAdapter.ZhongDianadpter;
...
import com.zhhl.ducha.activity.ZDActivity.ZhongDianactivity.ZhongDianDeteilsActivity;
 ...
 */
public class ZhongDianAdpter extends RecyclerView.Adapter<ZhongDianAdpter.ViewHolder>
{
    private Context mContext;
    private List<ZhongDianActivitybean.AttributesBean.VarListBean> dataList = new ArrayList<>();


    public void addAllData(List<ZhongDianActivitybean.AttributesBean.VarListBean> dataList) {
    ...
    public ZhongDianAdpter(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent=new Intent(mContext, ZhongDianDeteilsActivity.class);
