 ...
 */
public class ZhongDiandetalisAdapter extends BaseAdapter
{
    List<ZhongDianDeteilsbean.AttributesBean.VarListBean> apk_list;
    LayoutInflater inflater;
    private Context context;
    private int selectorPosition;

    public ZhongDiandetalisAdapter(Context context, List<ZhongDianDeteilsbean.AttributesBean.VarListBean> apk_list)
    {
    ...
    public void onDateChange(List<ZhongDianDeteilsbean.AttributesBean.VarListBean> apk_list)
    {
        this.apk_list = apk_list;
    ...
    {
        // TODO Auto-generated method stub
        final ZhongDianDeteilsbean.AttributesBean.VarListBean entity = apk_list.get(position);
        ViewHolder holder;
        if (convertView == null)
        {
...
//        点击收缩按钮
    ...
    public void addListView(ZhongDianDeteilsbean.AttributesBean.VarListBean pBean)
    {
        apk_list.add(pBean);
