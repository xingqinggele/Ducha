 ...
 */
public class SWweicheguandetalisAdapter extends BaseAdapter
{
    List<Detedetailsbean.AttributesBean.VarListBean> apk_list;
    LayoutInflater inflater;
    private Context context;
    private int selectorPosition;

    public SWweicheguandetalisAdapter(Context context, List<Detedetailsbean.AttributesBean.VarListBean> apk_list)
    {
    ...
    public void onDateChange(List<Detedetailsbean.AttributesBean.VarListBean> apk_list)
    {
        this.apk_list = apk_list;
    ...
    {
        // TODO Auto-generated method stub
        final Detedetailsbean.AttributesBean.VarListBean entity = apk_list.get(position);
        ViewHolder holder;
        if (convertView == null)
        {
...
//        点击收缩按钮
    ...
    public void addListView(Detedetailsbean.AttributesBean.VarListBean pBean)
    {
        apk_list.add(pBean);
