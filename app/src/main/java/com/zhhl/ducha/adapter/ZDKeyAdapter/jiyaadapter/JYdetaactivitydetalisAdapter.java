 ...
 */
public class JYdetaactivitydetalisAdapter extends BaseAdapter
{
    List<JYDeaddeteilsbean.AttributesBean.ZdrListBean> apk_list;
    LayoutInflater inflater;
    private Context context;
    private int selectorPosition;

    public JYdetaactivitydetalisAdapter(Context context, List<JYDeaddeteilsbean.AttributesBean.ZdrListBean> apk_list)
    {
    ...
    public void onDateChange(List<JYDeaddeteilsbean.AttributesBean.ZdrListBean> apk_list)
    {
        this.apk_list = apk_list;
    ...
    {
        // TODO Auto-generated method stub
        final JYDeaddeteilsbean.AttributesBean.ZdrListBean entity = apk_list.get(position);
        ViewHolder holder;
        if (convertView == null)
        {
...
//        点击收缩按钮
    ...
    public void addListView(JYDeaddeteilsbean.AttributesBean.ZdrListBean pBean)
    {
        apk_list.add(pBean);
