 ...
 */
public class JYyisiwangadpter extends RecyclerView.Adapter<JYyisiwangadpter.ViewHolder>
{
    private Context mContext;
    private List<JYDeadbean.AttributesBean.VarListBean> dataList = new ArrayList<>();


    public void addAllData(List<JYDeadbean.AttributesBean.VarListBean> dataList) {
    ...
    public JYyisiwangadpter(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent=new Intent(mContext, JYdetaActivityDeteils.class);
