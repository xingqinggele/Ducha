...
import com.zhhl.ducha.activity.ZDActivity.jiyaactivity.JYZaitaoActivityDeteils;
 ...
 */
public class JYzaitaoadpter extends RecyclerView.Adapter<JYzaitaoadpter.ViewHolder>
{
    private Context mContext;
    private List<JYzaitaobean.AttributesBean.VarListBean> dataList = new ArrayList<>();


    public void addAllData(List<JYzaitaobean.AttributesBean.VarListBean> dataList) {
    ...
    public JYzaitaoadpter(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent=new Intent(mContext, JYZaitaoActivityDeteils.class);
