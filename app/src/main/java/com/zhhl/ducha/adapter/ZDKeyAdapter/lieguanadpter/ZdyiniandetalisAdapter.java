 ...
 */
public class ZdyiniandetalisAdapter extends BaseAdapter
{
    List<ZDyiniandetailsbean.AttributesBean.ZdrListBean> apk_list;
    LayoutInflater inflater;
    private Context context;
    private int selectorPosition;

    public ZdyiniandetalisAdapter(Context context, List<ZDyiniandetailsbean.AttributesBean.ZdrListBean> apk_list)
    {
    ...
    public void onDateChange(List<ZDyiniandetailsbean.AttributesBean.ZdrListBean> apk_list)
    {
        this.apk_list = apk_list;
    ...
    {
        // TODO Auto-generated method stub
        final ZDyiniandetailsbean.AttributesBean.ZdrListBean entity = apk_list.get(position);
        ViewHolder holder;
        if (convertView == null)
        {
...
//        点击收缩按钮
    ...
    public void addListView(ZDyiniandetailsbean.AttributesBean.ZdrListBean pBean)
    {
        apk_list.add(pBean);
